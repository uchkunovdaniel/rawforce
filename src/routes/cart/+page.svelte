...
<main class="w-screen h-screen flex justify-center max-lg:justify-end-safe items-center-safe gap-20 pt-20 p-10 max-lg:flex-col max-lg:mt-10 max-lg:mb-30">
    <section class="w-160 max-md:w-full flex flex-col gap-4">
        ...
        <!--                        <div class="w-48 h-32 rounded-xl bg-(&#45;&#45;pink)"></div>-->
                                ...
                                <div class="flex gap-1">
                                    ...
                                    <p class="text-xl max-md:text-xs max-md:items-center max-md:flex max-md:w-16 bg-(--pink) px-2 rounded-md text-oswald-b h-7 font-light">{product.price} лв.</p>
                                </div>
                        </article>
                </section>
            {/each}
...
<div class="flex justify-end items-center mr-18 mt-[-4rem]">
